...
#define ENABLE_DYCO		1
#define MAX_BUFFER_LENGTH	1024


#define write(a, b, c)		dyco_send(a, b, c, 0)
#define send(a, b, c, d)	dyco_send(a, b, c, d)
#define read(a, b, c)		dyco_recv(a, b, c, 0)
#define recv(a, b, c, d)	dyco_recv(a, b, c, d)
#define connect(a, b, c)	dyco_connect(a, b, c)
#define socket(a, b, c)		dyco_socket(a, b, c)
#define close(a)			dyco_close(a)
#define accept(a, b, c)		dyco_accept(a, b, c)
